...
export function Header({ onMenuClick }: Props) {
  ...
  return (
    <header className="flex-shrink-0 h-14 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 flex items-center px-4 gap-3 shadow-sm z-20">
      {/* Mobile menu button */}
      <button
        onClick={onMenuClick}
